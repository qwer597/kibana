...
export const Left2DetailsPanelKey: Left2Panel['key'] = 'left2';

export const Left2DetailsPanel: React.FC<Left2Panel> = React.memo(({ path }) => {
    ...
    <EuiFlexGroup direction="column" css={{ backgroundColor: '#F04E98', height: '100%' }}>
      ...
      <EuiFlexItem grow={false}>
        <EuiButton onClick={() => closePanels({ left: undefined })}>
          <FormattedMessage id="left2.close" defaultMessage="Close left2 panel" />
        </EuiButton>
      </EuiFlexItem>
    </EuiFlexGroup>
  );
